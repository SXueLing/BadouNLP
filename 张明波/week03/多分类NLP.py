...
作业：修改nlpdemo，做一个多分类任务，判断特定字符在字符串的第几个位置，使用RNN和交叉熵
假设特定字符为 “你”
"""
...
def build_sample(vocab, sentence_length):
    chars = "你我他defghijklmnopqrstuvwxyz"  #字符集
    chars_list = list(chars[:sentence_length])
    #随机从字表选取sentence_length个字，可能重复
    random.shuffle(chars_list)  # 用于打乱列表的,原地打乱
    x = chars_list
    # print(x)
    if x is not None:
        index = x.index("你")
...
if __name__ == "__main__":
    main()
    test_strings = ["你我他fde", "ef你d我他", "edf我你他"]
